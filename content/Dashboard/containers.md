...
| `legendInline` | `boolean` | Легенда встаёт в одну строку справа от подписи оси X. Игнорируется при `twoColumns` и при незаданной подписи оси X |
