...
Нижняя граница сетки — особый случай: она меняет `options.height` корневого узла (в пикселях) и одновременно пересчитывает доли всех строк, чтобы верхние остались прежней высоты. Доступна только у корневой сетки сессии: у вложенной снизу лежит трек чужой раскладки, и её высотой распоряжается родитель.
